  ...
  return (
    <div className="modal__overlay" onMouseDown={(e) => e.target.classList.contains("modal__overlay") && onClose()}>
      <div className="modal" role="dialog" aria-modal="true">
        ...
        <h2 className="modal__title">Agregar Usuario Móvil</h2>
        <div className="modal__body">
          <form id="add-user-form" className="modal__form" onSubmit={handleSubmit}>
            ...
            <div className="form__row">
              <div className="form__group">
                ...
                <input id="correo" type="email" name="correo" value={formData.correo} onChange={handleChange} />
              </div>
              <div className="form__group">
        ...
        <div className="modal__actions">
          ...
          <button type="submit" form="add-user-form" className="btn btn--primary" disabled={isSubmitting}>
